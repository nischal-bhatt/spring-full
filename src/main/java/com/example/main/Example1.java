...
public class Example1 {
    ...
    public static void main(String[] args) {
    	...
    	// here, we are using the new keyword, 
    	// this object is not managed by the spring framework
        ...
        * */
        ...
        //we can tell the context which bean to retrieve
        // by passing the first value as the name of the
        //method in the config --> in this case hellohi
